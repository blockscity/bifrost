...
export function registerScreens(store, provider) {
    ...
    Navigation.registerComponent('bifrost.Me', () => Me, store, provider);
    Navigation.registerComponent('bifrost.Profile', () => Profile, store, provider);
    Navigation.registerComponent('bifrost.Settings', () => Settings, store, provider);
